...
namespace Rocky.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            List<int> prodIntCart = shoppingCartList.Select(x => x.ProductId).ToList();
            IEnumerable<Product> prodList = _db.Product.Where(x => prodIntCart.Contains(x.Id));
        ...
        public async Task<IActionResult> SummaryPost(ProductUserVM ProductUserVM)
        {
            ...
            {
                productListSB.Append($" - Nazwa: {prod.Name} <span style='font-size:14px;'> (ID: {prod.Id})</span><br />");
            }
